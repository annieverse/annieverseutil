...
function compareTwoStrings(first, second) {
    if (typeof first !== `string`)
        throw new InvalidArgumentException(`Bad arguments: First argument should be a string`);
    if (typeof second !== `string`)
        throw new InvalidArgumentException(`Bad arguments: Second argument should be a string`);
...
function findBestMatch(mainString, targetStrings) {
    if (!areArgsValid(mainString, targetStrings))
        throw new InvalidArgumentException(`Bad arguments: First argument should be a string, second should be an array of strings`);
    const ratings = [];
